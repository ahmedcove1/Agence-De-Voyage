 ...
 */
final class Version20181126221117 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__reservation AS SELECT id, nom, prenom, telephone, email, circuit_reserve FROM reservation');
        $this->addSql('DROP TABLE reservation');
        $this->addSql('CREATE TABLE reservation (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, nom VARCHAR(255) NOT NULL COLLATE BINARY, prenom VARCHAR(255) NOT NULL COLLATE BINARY, telephone VARCHAR(255) NOT NULL COLLATE BINARY, email VARCHAR(255) NOT NULL COLLATE BINARY, circuit_reserve VARCHAR(255) NOT NULL)');
        $this->addSql('INSERT INTO reservation (id, nom, prenom, telephone, email, circuit_reserve) SELECT id, nom, prenom, telephone, email, circuit_reserve FROM __temp__reservation');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__reservation AS SELECT id, nom, prenom, telephone, email, circuit_reserve FROM reservation');
        $this->addSql('DROP TABLE reservation');
        $this->addSql('CREATE TABLE reservation (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, telephone VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, circuit_reserve VARCHAR(3) NOT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO reservation (id, nom, prenom, telephone, email, circuit_reserve) SELECT id, nom, prenom, telephone, email, circuit_reserve FROM __temp__reservation');
        $this->addSql('DROP TABLE __temp__reservation');
    }
}
